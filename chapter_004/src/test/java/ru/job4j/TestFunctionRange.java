...
public class TestFunctionRange {
    ...
    public void whenLinFunction() {
        ...
        assertThat(rst, is(List.of(6D, 8D, 10D, 12D, 14D, 16D, 18D, 20D, 22D)));
    }
    ...
    public void whenQuadrFunction() {
        ...
        assertThat(rst, is(List.of(6D, 11D, 18D, 27D, 38D, 51D, 66D, 83D, 102D)));
    }
    ...
    public void whenLogFunction() {
        ...
        System.out.println(rst);
        assertThat(rst, is(List.of(0D, 0D, 1D, 1D, 1D, 1D, 1D, 2D, 2D)));
    }
}
